        ...
        <>
            <DashboardLayout>
                <ContentLayout>
                    ...
                    <div className="bg-white w-[100%] h-[90%] flex flex-col p-3 shadow-dark-gray">
                                            ...
                                            <TableHead className="flex gap-1 justify-start items-center mt-2 border-r-0">
                                                ...
                                                <AlertDialog open={isAlertDialogOpen} onOpenChange={setIsAlertDialogOpen}>
                                                    <AlertDialogTrigger asChild>
                                                        <Button onClick={openAlertDialog} className=" hover:bg-green-700 bg-gray-600 h-4 text-white text-xs font-lato">Release</Button>
                                                    </AlertDialogTrigger>
                                        ...
                                        {data.map((row, index) => (
                                            <TableRow className="h-[2rem]" key={index}>
                                                ...
                                                <TableCell className="flex gap-1 justify-evenly w-full items-center border-r-0 font-lato">
                                                    <div className="w-3 h-3 bg-white border flex justify-center items-center font-lato">
                                                        <div className="w-1.5 h-1.5 bg-black">
                                                            <ManualTransactions />
                                                        </div>
                                                    </div>
                                                    <Button className="bg-green-600 h-4 text-white text-xs font-lato">Release</Button>
                                                    <Decline />
                                                </TableCell>
                                            </TableRow>
                                        ))}
