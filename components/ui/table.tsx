...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-6 px-2 border-r text-sm border-gray-400 text-left align-middle [&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn("px-2 border-r border-gray-400 align-middle [&:has([role=checkbox])]:pr-0", className)}
    {...props}
  />
))
