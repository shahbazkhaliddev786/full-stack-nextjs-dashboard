            ...
            <div className="#F0F3EE w-[95%] flex flex-col mt-3">
                ...
                <div className="p-3 bg-white" style={{boxShadow: '10px 10px 4px 0px rgba(0, 0, 0, 0.05)'}}>
                    <Table className="text-xs bg-white rounded-[10px]">
                        <TableHeader>
                            <TableRow>
                                <TableHead className="w-[80px] font-lato font-bold text-[#14302A]">Date</TableHead>
                                ...
                                <TableHead className="font-bold font-lato text-[#14302A]">Decline Reason</TableHead>
                                                        ...
                                                        >
                                                            <Dialog.Panel className="w-full max-w-lg p-7 bg-white rounded-[10px] border-[2px] border-[#00CE7E] shadow-xl transform transition-all">
                                                                ...
                                                                <div className="mb-[30px] mt-[40px] flex justify-center space-x-2">
                                                                    <Button onClick={toggleModal} className="text-[14px] px-[20px] py-[10px] uppercase rounded-[10px] font-lato bg-[#00CE7E] hover:bg-green-700 text-white">Release</Button>
                                                                    <Button onClick={toggleModal} className="text-[14px] px-[20px] py-[10px] uppercase font-lato bg-[#AA322D] hover:bg-red-900 text-white rounded-[10px]">Cancel</Button>
                                                                </div>
                                                            </Dialog.Panel>
                                                        </Transition.Child>
                                                    </div>
                        ...
                        <TableBody>
                            {declined.map((row, index) => (
                                <TableRow key={index} className="h-[1.5rem]">
                                    <TableCell className="w-[10%] font-lato text-[#14302A]">{row.date}</TableCell>
                                    ...
                                    <TableCell className="text-[#005640] underline font-lato">{row.view}</TableCell>
