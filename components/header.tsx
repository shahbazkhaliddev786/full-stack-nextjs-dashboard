    ...
    return (
        <>
            <header
                ...
                className="header z-0 flex justify-between items-center text-white bg-white h-[10vh] w-[100%] left-auto top-0 right-0 drop-shadow-[5px_0px_10px_rgba(0,0,0,0.25)]">
