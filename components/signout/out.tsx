                        ...
                        <div className="w-full flex flex-col  mx-auto lg:flex-row lg:items-center">
                            ...
                            <div className="m-7 w-full ml-[5rem]">
                                ...
                                <div className=" mt-[35px]">
                                    <Button type="button" className="w-[100px] h-[40px] text-white hover:bg-[#03945d] rounded-[10px] bg-[#00CE7E] focus:outline-none font-lato"><Link href="/">Sign In</Link></Button>
                                </div>
                            </div>
