                                    ...
                                    <div className="mt-2 text-sm">
                                        <form>
                                            ...
                                            <div className='flex justify-center gap-2 mb-4 w-[100%]'>
                                                ...
                                                <div className='w-[50%]'><Input placeholder='Sample Text' className="p-2 placeholder:text-[#005640] font-lato placeholder-top-left h-[110.92px] text-xs border rounded w-[11rem] bg-gray-200 text-green-800" /></div>
                                            </div>
                                            <div className='flex justify-center gap-2 mb-4 w-[100%]'>
